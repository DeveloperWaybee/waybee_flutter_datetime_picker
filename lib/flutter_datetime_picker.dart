...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DPT.DPTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(DPT.DPTheme theme) {
  ...
  Widget _renderItemView(DPT.DPTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DPT.DPTheme theme) {
